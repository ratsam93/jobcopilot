...
async def get_profile(candidate_profile_id: UUID) -> dict[str, object]:
    return store.profile_summary(candidate_profile_id)


@router.post("/career-vault/profile/{candidate_profile_id}/update")
async def update_profile(candidate_profile_id: UUID, payload: ProfileUpdateInput) -> dict[str, object]:
...
async def list_skills(candidate_profile_id: UUID) -> list[dict[str, object]]:
...
async def create_skill(candidate_profile_id: UUID, payload: SkillInput) -> dict[str, object]:
...
async def create_claim(candidate_profile_id: UUID, payload: ClaimInput) -> dict[str, object]:
...
async def create_do_not_claim(candidate_profile_id: UUID, payload: DoNotClaimInput) -> dict[str, object]:
...
async def list_bullets(candidate_profile_id: UUID) -> list[dict[str, object]]:
...
async def create_bullet(candidate_profile_id: UUID, payload: BulletInput) -> dict[str, object]:
